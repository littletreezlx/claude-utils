...
- [project_flametree_ai.md](project_flametree_ai.md) — flametree_ai 项目协作记忆
- [feedback_anti_means_as_end.md](feedback_anti_means_as_end.md) — 基于文档条目否决方案前必须还原成「目的 vs 手段」的因果链，发现文档把手段写成目的时主动提议修改
