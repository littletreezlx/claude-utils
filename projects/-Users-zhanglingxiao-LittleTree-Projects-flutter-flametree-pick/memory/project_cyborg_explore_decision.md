...
description: 2026-04-06 决策：explore 演进为 Vision+OS Tap+State Oracle 模式（方案 D），分两阶段：POC 验证 → skill 重写
type: project
---
...
- 执行顺序：先完成 L1.5 端点 → POC 验证闭环 → 成功则重写 3 个 explore skills
- POC 失败则退回方案 C（现有 + 归因纪律 + L1.5）
