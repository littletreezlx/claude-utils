...
| **违反冰山策略** ⭐ | E2E 测试过多，单元测试不足 | E2E 占 80%，但只测试简单 CRUD |
| **缺少 Test Facade** ⭐ | E2E 通过 UI 准备测试数据，慢且脆 | 点击 10 次按钮才能创建测试状态 |
...
| **违反冰山策略** ⭐ | E2E 测试占比过高 | 转移重心到单元测试 |
| **缺少 Test Facade** ⭐ | E2E 通过 UI 准备数据 | 创建 test_facade.dart 绕过 UI |
